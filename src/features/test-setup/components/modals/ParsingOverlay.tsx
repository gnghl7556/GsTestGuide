...
export function ParsingOverlay({ visible, progress }: ParsingOverlayProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[var(--overlay-backdrop)] p-6 backdrop-blur-sm">
      <div className="w-full max-w-md rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#0f172a] shadow-xl text-slate-900 dark:text-white">
        <div className="px-5 py-6 text-center space-y-3">
          ...
          <div className="mt-2 space-y-3 text-left">
            <div className="text-[11px] text-slate-400 dark:text-white/50">추출 단계 진행</div>
            ...
            <div className="grid grid-cols-2 gap-2 text-[11px] text-slate-400 dark:text-white/50">
              <span>1) 시험신청번호</span>
          ...
          <div className="text-[11px] text-slate-400 dark:text-white/50">허용 가능한 최대 시간: 약 3분</div>
        </div>
      </div>
    </div>
  );
